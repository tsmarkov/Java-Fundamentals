 ...
 *  @method Collection<BaseItem> getItems() - a getter which extracts the items from the Inventory of the Hero
 *  @method void addItem(BaseItem item) - a method which adds an CommonItem to the Inventory of the Hero
